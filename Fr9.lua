...
Closed.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
...
Closed.Image = "http://www.roblox.com/asset/?id=12258186601"
...
local bgst = Instance.new("Frame")
local zense = Instance.new("TextLabel")
local logosi = Instance.new("ImageLabel")
local linesd = Instance.new("Frame")
local v67 = Instance.new("TextLabel")
local toshit = Instance.new("TextLabel")

bgst.Name = "bgst"
bgst.Parent = Main
bgst.BackgroundColor3 = Color3.fromRGB(34,34,34)
bgst.BorderColor3 = Color3.fromRGB(153,50,204)
bgst.BorderSizePixel = 2
bgst.ZIndex = 1
bgst.Position = UDim2.new(0, 0, 0.023, 0)
bgst.Size = UDim2.new(0, 560, 0, 100)

zense.Name = "zense"
zense.Parent = bgst
zense.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
zense.BackgroundTransparency = 1.000
zense.Position = UDim2.new(0.233506501, 0, 0.247391284, 0)
zense.Size = UDim2.new(0, 280, 0, 50)
zense.Font = Enum.Font.Gotham
zense.Text = "NEVA HUB"
zense.TextColor3 = Color3.fromRGB(255, 255, 255)
zense.TextScaled = true
zense.TextSize = 14.000
zense.TextWrapped = true

logosi.Name = "logosi"
logosi.Parent = bgst
logosi.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
logosi.BackgroundTransparency = 1.000
logosi.Position = UDim2.new(-0.0242532454, 0, 0.0668115243, 0)
logosi.Size = UDim2.new(0, 168, 0, 90)
logosi.Image = "rbxassetid://12258186601"

linesd.Name = "linesd"
linesd.Parent = bgst
linesd.BackgroundColor3 = Color3.fromRGB(153,50,204)
linesd.Position = UDim2.new(0.258506447, 0, 0.317681134, 0)
linesd.Size = UDim2.new(0, 3, 0, 54)

v67.Name = "v67"
v67.Parent = bgst
v67.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
v67.BackgroundTransparency = 1.000
v67.Position = UDim2.new(0.539610386, 0, 0.237391338, 0)
v67.Size = UDim2.new(0, 280, 0, 50)
v67.Font = Enum.Font.Gotham
v67.Text = "NEW!"
v67.TextColor3 = Color3.fromRGB(153,50,204)
v67.TextScaled = true
v67.TextSize = 14.000
v67.TextStrokeColor3 = Color3.fromRGB(153,50,204)
v67.TextWrapped = true

toshit.Name = "toshit"
toshit.Parent = bgst
toshit.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
toshit.BackgroundTransparency = 1.000
toshit.Position = UDim2.new(0.166136369, 0, 0.499710143, 0)
toshit.Size = UDim2.new(0, 340, 0, 70)
toshit.Font = Enum.Font.Gotham
toshit.Text = "https://discord.gg/k4Zn65YxdA"
toshit.TextColor3 = Color3.fromRGB(255, 255, 255)
toshit.TextSize = 14.000
toshit.TextWrapped = true
	...
	Logo.Image = "rbxassetid://12258186601"
	Logo.Visible = false
...
local Hub = Instance.new("TextLabel")
	...
	Hub.Position = UDim2.new(0, 60, 0, 0)
	Hub.Size = UDim2.new(0, 50, 0, 27)
	Hub.Font = Enum.Font.GothamSemibold
	Hub.Text = "HUB"
	Hub.TextColor3 = Color3.fromRGB(153,50,204)
	Hub.TextSize = 20.000
...
local ListNof = Instance.new("Frame")
	...
	function Update:Nof(txt,tine)
		spawn(function()
			...
			NofLabel.ZIndex = 4
			NofLabel.Font = Enum.Font.GothamSemibold
    ...
    function Update:Notification(textdesc)
        ...
        NotificationTitle.TextColor3 = Color3.fromRGB(153,50,204)
...
NotificationDesc.TextScaled = false
        ...
        OkayBtn.MouseEnter:Connect(function()
            TweenService:Create(OkayBtn, TweenInfo.new(.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BackgroundColor3 = Color3.fromRGB(34,34,34)}):Play()
        end)
...
local Hub1 = Instance.new("TextLabel")
	...
	Hub1.Font = Enum.Font.GothamSemibold
...
local Tab = Instance.new("Frame")
	...
	ScrollTab.Size = UDim2.new(0, 170, 0, 240)
	...
	Page.Position = UDim2.new(0.305426834, 0, 0.31, 0)
	...
	WindowStrokeshit.Color = Color3.fromRGB(153,50,204)
	...
	WindowStrokeshit.Enabled = false
	...
	function uitab:Tab(text, img)
		...
		WindowStroke.Color = Color3.fromRGB(153,50,204)
		...
		MainFramePage.Size = UDim2.new(0, 390, 0, 230)
...
function main:Button(btitle, callback)
                ...
                Button.Position = UDim2.new(0.397777791, 0, 0.310000002, 0)
		...
		function main:Button1(text,callback)
			...
			TextBtn.BackgroundColor3 = Color3.fromRGB(34,34,34)
...
ImageLabel.Name = "ImageLabel"
			...
			Button.MouseButton1Click:Connect(function()
				if toggled == false then
					...
					TweenService:Create(
						Circle,
						TweenInfo.new(0.4,Enum.EasingStyle.Quad,Enum.EasingDirection.Out),
						{BackgroundColor3 = Color3.fromRGB(153,50,204)}
					):Play()
				end
    ...
    WindowStrokemain.Parent = Dropdown
    WindowStrokemain.ApplyStrokeMode = Enum.ApplyStrokeMode.Border
    WindowStrokemain.Color = Color3.fromRGB(153,50,204)
    ...
    WindowStrokemain.Archivable = true
			...
			Dropdown.Size = UDim2.new(0, 360, 0, 31)
			...
			DropTitle.Size = UDim2.new(0, 360, 0, 31)
			...
			DropImage.Position = UDim2.new(0, 335, 0, 6)
			...
			for i,v in next,option do
				...
				Item.Size = UDim2.new(0, 360, 0, 26)
				...
				Item.MouseButton1Click:Connect(function()
					isdropping = false
					Dropdown:TweenSize(UDim2.new(0,360,0,31),"Out","Quad",0.3,true)
					TweenService:Create(
						DropImage,
						TweenInfo.new(0.3,Enum.EasingStyle.Quad,Enum.EasingDirection.Out),
						{Rotation = 180}
			...
			DropButton.MouseButton1Click:Connect(function()
				if isdropping == false then
					isdropping = true
					Dropdown:TweenSize(UDim2.new(0,360,0,131),"Out","Quad",0.3,true)
					TweenService:Create(
						DropImage,
						TweenInfo.new(0.3,Enum.EasingStyle.Quad,Enum.EasingDirection.Out),
						{Rotation = 0}
...
function main:Slider(text,min,max,set,callback)
			...
			Slider.BackgroundColor3 = Color3.fromRGB(153,50,204)
			Slider.BackgroundTransparency = 0
			Slider.Size = UDim2.new(0, 362, 0, 51)
			...
			sliderr.BackgroundColor3 = Color3.fromRGB(34, 34, 34)
			sliderr.Position = UDim2.new(0, 1, 0, 1)
			sliderr.Size = UDim2.new(0, 360, 0, 49)
			...
			HAHA.Size = UDim2.new(0, 360, 0, 29)
			...
			AHEHE.Size = UDim2.new(0, 360, 0, 5)
			...
			slidervalue.Position = UDim2.new(0, 290, 0, 5)
            ...
            function main:Textbox(boxtitle, desc, callback,def)
                ...
                TextBox.Size = UDim2.new(0, 360, 0, 65)
		...
		function main:Textbox1(text,disappear,callback)
			...
			Textboxx.BackgroundColor3 = Color3.fromRGB(34,34,34)
...
function Label1func:Refresh(tochange)
		...
		function main:Seperator(text)
			...
			Sep1.BackgroundColor3 = Color3.fromRGB(153,50,204)
			...
			Sep3.BackgroundColor3 = Color3.fromRGB(153,50,204)
		...
		function main:Line()
			...
			Line.Name = "Line"
			Line.Parent = Linee
			Line.BackgroundColor3 = Color3.fromRGB(153,50,204)
			Line.BorderSizePixel = 0
    ...
    --------------------------------------------------------------------
    local Library = Update:Window("NEVA HUB IS BACK");
    --------------------------------------------------------------------
   
    Main = Library:Tab("Main",6026568198)
Farm = Library:Tab("AutoFarm/Quest",7251993295)
Stats = Library:Tab("Stats",11447069304)
Combat = Library:Tab("Players",11446900930)
...
RaceV4 = Library:Tab("RaceV4",11446900930)
    --------------------------------------------------------------------
    Update:Notification("HELLO , "  ..game.Players.LocalPlayer.DisplayName.. "NEVA HUB IS BACK.  |THIS NOT THE LAST UPDATE")
...
Main:Slider('Bring Mob',1, 1000,100,function(value)
  bringfrec = value
end)
...
task.spawn(function()
  while task.wait() do
  if BringMobs or AutoFarmQuest then
  pcall(function()
...
spawn(function()
  pcall(function()
    while wait() do
    if AutoFarmHeart or AutoFarmNearestMob or _G.BossRaid or _G.GrabChest or AutoCitizen or AutoEcto or AutoEvoRace or AutoBartilo or AutoFactory or BringChestz or BringFruitz or _G.d or AutoFarmQuest or _G.Clip2 or AutoFarmQuest or AutoFarmBone or AutoFarmSelectMonsterQuest or AutoFarmSelectMonsterNoQuest or AutoFarmBossNoQuest or AutoFarmBossQuest or AutoFarmMasGun or AutoFarmMasDevilFruit or AutoFarmSelectArea or AutoSecondSea or AutoThirdSea or AutoDeathStep or AutoSuperhuman or AutoSharkman or AutoElectricClaw or AutoDragonTalon or AutoGodhuman or AutoRengoku or AutoBuddySword or AutoPole or AutoHallowSycthe or AutoCavander or AutoTushita or AutoDarkDagger or AutoCakePrince or AutoEliteHunter or AutoRainbowHaki or AutoSaber or AutoFarmKen or _G.Mirage or AutoKenHop or AutoKenV2 or KillPlayerMelee or KillPlayerGun or KillPlayerFruit or AutoDungeon or AutoNextIsland or AutoAdvanceDungeon or Musketeer or RipIndra or Auto_Serpent_Bow or AutoTorch or AutoSoulGuitar or Auto_Cursed_Dual_Katana or AutoFarmMaterial or Auto_Quest_Yama_1 or Auto_Quest_Yama_2 or Auto_Quest_Yama_3 or Auto_Quest_Tushita_1 or Auto_Quest_Tushita_2 or Auto_Quest_Tushita_3 or _G.Factory or _G.SwanGlasses or AutoBartilo or AutoEvoRace or AutoEcto then
...
--// Auto Farm Quest
Main:Toggle("Auto Farm (Quest)", AutoFarmQuest, function(afq)
    AutoFarmQuest = afq
    SelectMonster = nil
...
Main:Toggle("Auto Farm (No Quest)", AutoFarmNoQuest, function(afnq)
    AutoFarmNoQuest = afnq
    SelectMonster = nil
    CancelTween(AutoFarmNoQuest)
end)
spawn(function()
                    ...
                    for i,v in pairs (game.Workspace.Enemies:GetChildren()) do
                        if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                            if v.Name == Ms then
                                ...
                                until not AutoFarmNoQuest or not v.Parent or v.Humanoid.Health <= 0 or not game:GetService("Workspace").Enemies:FindFirstChild(v.Name)
                            end
                        end
                    end
                else
...
Main:Toggle('Auto Farm Nearest Mobs', AutoFarmNearestMob, function(nearfarmf)
...
Shop:Button("Random Race (Use 3K Fragments)", function()
    ...
    Misc:Button("Destroy Ui",function()
        if game.CoreGui:FindFirstChild("SAGI HUB") then
            game.CoreGui:FindFirstChild("SAGI HUB"):Destroy()
